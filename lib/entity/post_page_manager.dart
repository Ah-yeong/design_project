...
class PostPageManager {
  ...
  Future<EntityPost?> getPostById(int _postId, bool isProcessingPost) async {
    try {
      EntityPost post = EntityPost(_postId, isProcessing: isProcessingPost);
      await post.loadPost();
      return post;
    } catch (e) {
      return null;
