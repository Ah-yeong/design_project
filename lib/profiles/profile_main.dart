              ...
              child: Center(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(padding: EdgeInsets.all(15), child: mannerWidget),
                    Divider(thickness: 1, height: 1),
                    GestureDetector(
                      onTap: () {
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                    child: Text(myProfile!.mbtiIndex == -1 ? "비공개" : mbtiList[myProfile!.mbtiIndex],
                                        textAlign: TextAlign.right,
                                        style: TextStyle(fontSize: 14, color: myProfile!.mbtiIndex == -1 ? Colors.grey : Colors.black)))
                              ]),
                              SizedBox(
                                height: 7,
                              ),
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  ...
                                  textAlign: TextAlign.right,
                                  style: TextStyle(fontSize: 14, color: myProfile!.commute == null ? Colors.grey : Colors.black),
                                ))
                              ]),
                              SizedBox(
                                height: 7,
